...
namespace Odyssey.Tests.Persistence
{
    ...
    public sealed class CharacterResourceAnatomyTests
    {
        ...
        public void CharacterAdvancementService_LivesInApplication_AndDependsOnlyOnTheICharacterRepositoryPort_NotOnAnySqlImplementation()
        {
            ...
            Assert.That(methods.Select(m => m.Name), Is.EquivalentTo(new[] { "InitializeResourceWithDefaults", "InitializeAnatomyWithDefaults", "PurchaseAttributeIncrease", "PurchaseSkillLevel", "RequestSkillAdvancedRecommendation", "AcquireAbility", "PreviewCharacterRespec", "ApplyCharacterRespec", "PreviewCharacterRulesetMigration", "ApplyCharacterRulesetMigration" }));
