...
namespace Odyssey.Tests.Persistence
{
    ...
    public sealed class CheckIntegrationTests
    {
        ...
        private sealed class FailsFirstCriticalSuccessEvidenceCharacterRepository : ICharacterRepository
        {
            ...
            public Result<CharacterRecord> PurchaseAttributeIncrease(CampaignHandle campaign, CharacterId characterId, AttributeDefinitionId attributeDefinitionId, long toValue, UserId actorUserId, bool actorIsMainGm, long expectedMechanicsRevision, long expectedAttributeRevision, CommandId commandId, CorrelationId correlationId) => _inner.PurchaseAttributeIncrease(campaign, characterId, attributeDefinitionId, toValue, actorUserId, actorIsMainGm, expectedMechanicsRevision, expectedAttributeRevision, commandId, correlationId);
            ...
            public Result<CharacterRecord> PurchaseSkillLevel(CampaignHandle campaign, CharacterId characterId, SkillDefinitionId skillDefinitionId, long toLevel, UserId actorUserId, bool actorIsMainGm, long expectedMechanicsRevision, long expectedSkillRevision, CommandId commandId, CorrelationId correlationId) => _inner.PurchaseSkillLevel(campaign, characterId, skillDefinitionId, toLevel, actorUserId, actorIsMainGm, expectedMechanicsRevision, expectedSkillRevision, commandId, correlationId);
            ...
            public Result<CharacterRecord> AcquireAbility(CampaignHandle campaign, CharacterId characterId, AbilityDefinitionId abilityDefinitionId, SourceKind sourceKind, string? sourceRef, RankMode rankMode, long? numericRank, string? namedRankKey, string configuration, UserId actorUserId, bool actorIsMainGm, long? expectedMechanicsRevision, long expectedCharacterAbilitiesRevision, CommandId commandId, CorrelationId correlationId) => _inner.AcquireAbility(campaign, characterId, abilityDefinitionId, sourceKind, sourceRef, rankMode, numericRank, namedRankKey, configuration, actorUserId, actorIsMainGm, expectedMechanicsRevision, expectedCharacterAbilitiesRevision, commandId, correlationId);
            ...
            public Result<CharacterRecord> InitializeCharacterAnatomy(CampaignHandle campaign, CharacterId characterId, AnatomyProfileDefinitionId anatomyProfileDefinitionId, UserId actorUserId, bool actorIsMainGm, long expectedCharacterAnatomyRevision, CommandId commandId, CorrelationId correlationId) => _inner.InitializeCharacterAnatomy(campaign, characterId, anatomyProfileDefinitionId, actorUserId, actorIsMainGm, expectedCharacterAnatomyRevision, commandId, correlationId);
