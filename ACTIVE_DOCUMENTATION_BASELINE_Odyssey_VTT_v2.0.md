...
`docs/tasks/active/ODY-S00-008_Fast_CI_and_Build_Identity.md` is the current `In Progress` child task on branch `feat/ody-s00-008-fast-ci-build-identity`. No PR is opened. ODY-S00-009 remains `Draft`.
