...
namespace Odyssey.Persistence.Sqlite
{
    ...
    public sealed class SqliteCombatEncounterRepository : ICombatEncounterRepository
    {
        ...
        {
            string[] tables = { "AppliedCommands", "InventoryCommandLedger", "InventoryMoveCommandLedger", "InventoryStackCommandLedger", "EquipmentCommandLedger", "ItemDefinitionMigrationCommandLedger", "ContentDefinitionCommandLedger", "ContentDefinitionDeleteLedger", "ActiveEffect" };
