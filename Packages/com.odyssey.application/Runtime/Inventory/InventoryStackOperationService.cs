...
namespace Odyssey.Application.Inventory
{
    ...
    public sealed class InventoryStackOperation
    {
        ...
        {
            if (!sourceId.IsValid || !resultId.IsValid || !inventoryId.IsValid || quantity < 1 || expectedSourceRevision < 1 || expectedInventoryRevision < 1 || !commandId.IsValid) throw new ArgumentException("A valid stack operation is required.");
        ...
        public ItemStackId SourceId { get; } public ItemStackId ResultId { get; } public InventoryId InventoryId { get; } public long Quantity { get; } public long ExpectedSourceRevision { get; } public long ExpectedResultRevision { get; } public long ExpectedInventoryRevision { get; } public CommandId CommandId { get; } public bool IsMerge { get; }
    }
    ...
    public sealed class SplitItemStackRequest
    {
        ...
        public CampaignHandle Campaign { get; } public bool ActorIsMainGm { get; } public CorrelationId CorrelationId { get; } public InventoryStackOperation Operation { get; }
    }
