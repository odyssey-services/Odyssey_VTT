...
- `ODY-S05-602` depends on `ODY-S05-601` and `ODY-S05-113`; `603` on `602`; `604` on `602`/`603`; `605` on `602`/`502`; `606` on `603`–`605`; `607` on `604`; `609` on `604`; `608` on `602`–`607` and `609`.
...
| 7 | `ODY-S05-609` | Proposed | `ADR-029` §1 rule 5, §6 stage 13, §12 item 4 | Attack Aggregate Delta Commit | 604 | ExecPlan | Applies accepted `AttackDelta` values to Character/Item state through the already-existing generic write paths; no new Ruleset formula. |
| 8 | `ODY-S05-608` | Proposed | `ADR-029` §12 | Full Attack Pipeline Integration Fixtures | 602-607, 609 | Brief plan | End-to-end proof of all nine §12 outcomes without new production behavior. |
