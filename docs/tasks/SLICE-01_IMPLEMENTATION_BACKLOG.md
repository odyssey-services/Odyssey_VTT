...
| 2 | `ODY-S01-008` | Campaign Storage | Scene and Token Minimal Model | In Review | 007 | ExecPlan | One `Scene`, two `SceneObject`/token records, asset manifest entry — the minimal domain model roadmap §10.5 steps 3–5 require |
