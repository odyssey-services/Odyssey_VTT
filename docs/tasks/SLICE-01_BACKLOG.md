...
| 4 | `ODY-S01-004` | ADR: Owner Key Storage Baseline | In Review (ADR Proposed, pending owner acceptance) | None | ExecPlan | OS secure-storage mechanism for the campaign owner key, implementing the principle confirmed in `Documentation/21_Security_And_Privacy_Odyssey_VTT_v0.1.md` section 5 |
