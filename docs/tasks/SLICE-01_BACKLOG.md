...
| 5 | `ODY-S01-005` | Technical Spike SP-02: Persistence Reliability | In Review (report drafted, pending owner decision) | 001, 002 | Brief plan | Report: SQLite WAL/transaction-mode reliability under crash, interrupted backup, migration failure/rollback, snapshot size/speed, and corrupted-database recovery, with selected strategy and measurements |
