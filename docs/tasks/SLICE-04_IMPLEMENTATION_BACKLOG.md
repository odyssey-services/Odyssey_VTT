...
**Status:** Implementation revision — OPEN. `ODY-S04-101` Done (PR [#85](https://github.com/odyssey-services/Odyssey_VTT/pull/85)); `ODY-S04-102` Done (PR [#86](https://github.com/odyssey-services/Odyssey_VTT/pull/86)); `ODY-S04-103`–`115` reserved, no task contract yet.
