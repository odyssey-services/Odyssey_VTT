...
| 8 | `ODY-S00-008` | PR-005A | Fast CI and Build Identity | In Progress | 003–007 | ExecPlan update | No-secret CI gates, mandatory local Unity merge validation, version generation, provenance and repository-policy gates |
