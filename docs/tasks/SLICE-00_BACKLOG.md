...
| 4 | `ODY-S00-004` | PR-003A | Identity, Version and Result Primitives | In Review | 003 | Brief plan | Typed IDs, version value objects, `Result/Error`, registries and unit tests |
