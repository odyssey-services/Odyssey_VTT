...
- ODY-S00-009 is Draft and unstarted. Its Ready activation is blocked by missing owner-approved TestCaseId/catalog mapping for the mandatory ADR-009 Windows build and Player smoke scenarios.
