...
**Status:** Done (PR #67, merged into main) — the Unity/`Odyssey.Persistence` compile gap was resolved by `ODY-UI-01-002a` (PR [#68](https://github.com/odyssey-services/Odyssey_VTT/pull/68), merged into `main`); this task's own 4 EditMode tests were then genuinely run for real (not merely reviewed) and all pass — see §17/§18.
