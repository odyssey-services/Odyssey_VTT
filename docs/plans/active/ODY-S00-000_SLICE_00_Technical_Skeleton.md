...
- ODY-S00-002 through ODY-S00-008 are Done. ODY-S00-009 is Draft and blocked pending owner-approved TestCaseId/catalog mapping for mandatory ADR-009 Windows build and Player smoke scenarios.
...
Next action: owner approves ODY-S00-009 TestCaseId/catalog mapping, then ODY-S00-009 can move from Draft to Ready and receive a separate implementation TЗ. Do not start ODY-S00-009 implementation or create a Player build before that decision.
