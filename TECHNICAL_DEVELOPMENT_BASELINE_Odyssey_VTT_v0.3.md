...
**Документ:** `TECHNICAL_DEVELOPMENT_BASELINE_Odyssey_VTT_v0.3.md`
**Версия:** 0.3
...
2. `ACTIVE_DOCUMENTATION_BASELINE_Odyssey_VTT_v1.8.md`;
...
До production use обязательна проверка System.Text.Json в pinned Unity 6.4 patch:
